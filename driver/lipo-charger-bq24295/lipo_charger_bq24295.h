...
#ifndef LIPO_CHARGER_BQ24295_HPP
#define LIPO_CHARGER_BQ24295_HPP

/**
 * @file lipo_charger_bq24295.h
...
/// Device I2C address
#define LIPO_CHARGER_BQ24295_ADDRESS 0x6B

// ----------------------------------------------------------------
// CLASSES
// ----------------------------------------------------------------

class LipoChargerBq24295 {
public:
    /// Charger state.
    typedef enum {
    ...
    /// Constructor.
    LipoChargerBq24295(void);
    /// Destructor.
    ~LipoChargerBq24295(void);

    /// Initialise the BQ24295 chip.
    // \return  true if successful, otherwise false.
    bool init (I2C * pI2c, uint8_t address = LIPO_CHARGER_BQ24295_ADDRESS);
